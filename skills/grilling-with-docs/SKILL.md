...
Run a `/grilling` session to interview the user about the plan or design — walking the design tree in rounds, each question numbered and paired with your recommended answer.
